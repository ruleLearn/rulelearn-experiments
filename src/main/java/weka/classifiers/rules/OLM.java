 ...
 * 
 <!-- options-end -->
 * 
 * This is the original version of OLM class only extended with the method {@link #getNumberOfRules()}.
 * 
 * @author TriDat Tran
...
implements OptionHandler, TechnicalInformationHandler {
  ...
  //*********************************************************************************************************** CHANGED CODE BEGIN
  /**
   * Gets number of rules.<br>
   * This method was missing in original implementation of OLM class!
   * 
   * @return number of rules (instances)
   * @author Marcin Szeląg (<a href="mailto:marcin.szelag@cs.put.poznan.pl">marcin.szelag@cs.put.poznan.pl</a>)
   */
  public int getNumberOfRules() {
	  return olmrules.rules.size();
  }
  //*********************************************************************************************************** CHANGED CODE END
